        ...
        for access_policy in try(domain.policies.access_policies, []) : [
          {
            ...
            default_action_intrusion_policy_id = try(local.map_intrusion_policies[access_policy.base_intrusion_policy].id, local.map_intrusion_policies[local.defaults.fmc.domains[domain.name].policies.access_policies.base_intrusion_policy].id, null)
            default_action_log_begin           = try(access_policy.log_begin, local.defaults.fmc.domains[domain.name].policies.access_policies.log_begin, null)
            default_action_log_end             = try(access_policy.log_end, local.defaults.fmc.domains[domain.name].policies.access_policies.log_end, null)
            default_action_send_events_to_fmc  = try(access_policy.send_events_to_fmc, local.defaults.fmc.domains[domain.name].policies.access_policies.send_events_to_fmc, null)
            default_action_send_syslog         = try(access_policy.enable_syslog, local.defaults.fmc.domains[domain.name].policies.access_policies.enable_syslog, null)
            ...
            default_action_syslog_severity  = try(access_policy.syslog_severity, local.defaults.fmc.domains[domain.name].policies.access_policies.syslog_severity, null)
            ...
            rules = [for rule in try(access_policy.access_rules, []) : {
              ...
              enabled             = try(rule.enabled, local.defaults.fmc.domains[domain.name].policies.access_policies.access_rules.enabled, null)
              file_policy_id      = try(local.map_file_policies[rule.file_policy].id, null)
              intrusion_policy_id = try(local.map_intrusion_policies[rule.intrusion_policy].id, local.defaults.fmc.domains[domain.name].policies.access_policies.access_rules.intrusion_policy, null)
              log_begin           = try(rule.log_connection_begin, local.defaults.fmc.domains[domain.name].policies.access_policies.access_rules.log_connection_begin, null)
              log_end             = try(rule.log_connection_end, local.defaults.fmc.domains[domain.name].policies.access_policies.access_rules.log_connection_end, null)
              log_files           = try(rule.log_files, local.defaults.fmc.domains[domain.name].policies.access_policies.access_rules.log_files, null)
              section             = try(rule.section, local.defaults.fmc.domains[domain.name].policies.access_policies.access_rules.section, null)
              send_events_to_fmc  = try(rule.send_events_to_fmc, local.defaults.fmc.domains[domain.name].policies.access_policies.access_rules.send_events_to_fmc, null)
              send_syslog         = try(rule.enable_syslog, local.defaults.fmc.domains[domain.name].policies.access_policies.access_rules.enable_syslog, null)
              ...
              syslog_severity  = try(rule.syslog_severity, local.defaults.fmc.domains[domain.name].policies.access_policies.syslog_severity, null)
        ...
        for ftd_nat_policy in try(domain.policies.ftd_nat_policies, []) : [
          {
            ...
            auto_nat_rules = [for auto_rule in try(ftd_nat_policy.ftd_auto_nat_rules, []) : {
              ...
              fall_through                                = try(auto_rule.fall_through, local.defaults.fmc.domains[domain.name].policies.ftd_nat_policies.ftd_auto_nat_rules.fall_through, null)
              ipv6                                        = try(auto_rule.ipv6, local.defaults.fmc.domains[domain.name].policies.ftd_nat_policies.ftd_auto_nat_rules.ipv6, null)
              net_to_net                                  = try(auto_rule.net_to_net, local.defaults.fmc.domains[domain.name].policies.ftd_nat_policies.ftd_auto_nat_rules.net_to_net, null)
              no_proxy_arp                                = try(auto_rule.no_proxy_arp, local.defaults.fmc.domains[domain.name].policies.ftd_nat_policies.ftd_auto_nat_rules.no_proxy_arp, null)
              ...
              route_lookup                                = try(auto_rule.perform_route_lookup, local.defaults.fmc.domains[domain.name].policies.ftd_nat_policies.ftd_manual_nat_rules.perform_route_lookup, null)
              protocol                                    = try(auto_rule.protocol, null)
              source_interface_id                         = try(local.map_security_zones[auto_rule.source_interface].id, null)
              translate_dns                               = try(auto_rule.translate_dns, local.defaults.fmc.domains[domain.name].policies.ftd_nat_policies.ftd_auto_nat_rules.translate_dns, null)
            ...
            manual_nat_rules = [for manual_rule in try(ftd_nat_policy.ftd_manual_nat_rules, []) : {
              ...
              enabled                           = try(manual_rule.enabled, local.defaults.fmc.domains[domain.name].policies.ftd_nat_policies.ftd_manual_nat_rules.enabled, null)
              fall_through                      = try(manual_rule.fall_through, local.defaults.fmc.domains[domain.name].policies.ftd_nat_policies.ftd_manual_nat_rules.fall_through, null)
              ...
              ipv6                              = try(manual_rule.ipv6, local.defaults.fmc.domains[domain.name].policies.ftd_nat_policies.ftd_manual_nat_rules.ipv6, null)
              net_to_net                        = try(manual_rule.net_to_net, local.defaults.fmc.domains[domain.name].policies.ftd_nat_policies.ftd_manual_nat_rules.net_to_net, null)
              no_proxy_arp                      = try(manual_rule.no_proxy_arp, local.defaults.fmc.domains[domain.name].policies.ftd_nat_policies.ftd_manual_nat_rules.no_proxy_arp, null)
              ...
              route_lookup                      = try(manual_rule.perform_route_lookup, local.defaults.fmc.domains[domain.name].policies.ftd_nat_policies.ftd_manual_nat_rules.perform_route_lookup, null)
              source_interface_id               = try(local.map_security_zones[manual_rule.source_interface].id, null)
              translate_dns                     = try(manual_rule.translate_dns, local.defaults.fmc.domains[domain.name].policies.ftd_nat_policies.ftd_manual_nat_rules.translate_dns, null)
              ...
              unidirectional                    = try(manual_rule.unidirectional, local.defaults.fmc.domains[domain.name].policies.ftd_nat_policies.ftd_manual_nat_rules.unidirectional, null)
            }]
        ...
        for file_policy in try(domain.policies.file_policies, []) : [
          {
            ...
            # Optional
            block_encrypted_archives     = try(file_policy.block_encrypted_archives, local.defaults.fmc.domains[domain.name].policies.file_policies.block_encrypted_archives, null)
            block_uninspectable_archives = try(file_policy.block_uninspectable_archives, local.defaults.fmc.domains[domain.name].policies.file_policies.block_uninspectable_archives, null)
            clean_list                   = try(file_policy.clean_list, local.defaults.fmc.domains[domain.name].policies.file_policies.clean_list, null)
            custom_detection_list        = try(file_policy.custom_detection_list, local.defaults.fmc.domains[domain.name].policies.file_policies.custom_detection_list, null)
            description                  = try(file_policy.description, null)
            first_time_file_analysis     = try(file_policy.first_time_file_analysis, local.defaults.fmc.domains[domain.name].policies.file_policies.first_time_file_analysis, null)
            inspect_archives             = try(file_policy.inspect_archives, local.defaults.fmc.domains[domain.name].policies.file_policies.inspect_archives, null)
            max_archive_depth            = try(file_policy.max_archive_depth, local.defaults.fmc.domains[domain.name].policies.file_policies.max_archive_depth, null)
            threat_score                 = try(file_policy.threat_score, local.defaults.fmc.domains[domain.name].policies.file_policies.threat_score, null)
        ...
        for prefilter_policy in try(domain.policies.prefilter_policies, []) : [
          {
            ...
            default_action = try(prefilter_policy.default_action, local.defaults.fmc.domains[domain.name].policies.prefilter_policies.default_action)

            default_action_log_begin           = try(prefilter_policy.log_begin, local.defaults.fmc.domains[domain.name].policies.prefilter_policies.log_begin, null)
            default_action_log_end             = try(prefilter_policy.log_end, local.defaults.fmc.domains[domain.name].policies.prefilter_policies.log_end, null)
            default_action_send_events_to_fmc  = try(prefilter_policy.send_events_to_fmc, local.defaults.fmc.domains[domain.name].policies.prefilter_policies.send_events_to_fmc, null)
            #default_action_send_syslog         = try(prefilter_policy.enable_syslog, local.defaults.fmc.domains[domain.name].policies.prefilter_policies.enable_syslog, null)
